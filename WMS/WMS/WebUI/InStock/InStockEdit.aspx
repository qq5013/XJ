    ...
    <title></title>
        ...
        <script type="text/javascript">
            ...
            function SelectProduct() {
                ...
                var where = "AreaCode='" + $('#ddlAreaCode').val() + "' and ProductCode not in ('0001','0002') and ProductCode not in (select ProductCode from cmd_Cell)";
            ...
            function BindEvent() {
                $("[ID$='ProductCode']").bind("change", function () {
                    var txtID = this.id;
                    var where = "AreaCode='" + $('#ddlAreaCode').val() + "' and ProductCode='" + $('#' + txtID).val() + "' and ProductCode not in ('0001','0002') and ProductCode not in (select ProductCode from cmd_Cell)";
